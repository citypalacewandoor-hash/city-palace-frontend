          ...
          <>
            <div className="flex flex-col mb-5">
              <span className="text-sm sm:text-base text-black/60 mb-3">
                Select Option: <span className="text-[#D31018] font-medium">{selectedVariant?.color}</span>
              </span>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedVariant?._id === v._id
                        ? "bg-[#D31018] text-white border-[#D31018] scale-105"
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedSize?._id === s._id
                        ? "bg-[#D31018] text-white border-[#D31018]"
                        : "bg-black/5 text-black border-black/10 hover:bg-black/10"
                    )}
                  >
                    {s.size.toUpperCase()}
              ...
              <div className="flex flex-wrap gap-2">
                {data.amenities.map((amenity, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-center gap-2 px-3 py-1.5 bg-[#FFF0F1] border border-[#F5C2C4] rounded-full text-[#D31018] text-sm font-medium hover:bg-[#FFE0E2] transition-colors"
                    >
                      <IoMdCheckmark className="text-[#D31018]" />
                      {amName}
                    </div>
                  );
                })}
